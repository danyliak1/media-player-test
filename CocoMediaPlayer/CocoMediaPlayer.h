...
//! Project version number for CocoMediaPlayer.
FOUNDATION_EXPORT double CocoMediaPlayerVersionNumber;

//! Project version string for CocoMediaPlayer.
FOUNDATION_EXPORT const unsigned char CocoMediaPlayerVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <CocoMediaPlayer/PublicHeader.h>
